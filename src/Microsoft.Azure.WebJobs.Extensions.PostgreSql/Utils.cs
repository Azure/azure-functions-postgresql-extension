...
namespace Microsoft.Azure.WebJobs.Extensions.PostgreSql
{
    ...
    public static class Utils
    {
        ...
        /// </summary>
        private static readonly JsonSerializerSettings DefaultJsonSerializationSettings;
        ...
        static Utils()
        {
            DefaultJsonSerializationSettings = new JsonSerializerSettings
            {
        ...
        /// <returns>True if the string is "true", "1", or "yes", false if the string is "false", "0", or "no", otherwise the default value.</returns>
