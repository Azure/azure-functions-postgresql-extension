// <copyright file="PostgreSqlBindingUtilities.cs" company="Microsoft Corporation">
...
{
    /// <summary>
    /// This class contains utility methods used by the PostgreSQL binding.
    /// </summary>
    internal static class PostgreSqlBindingUtilities
    {
        ...
        /// <param name="connection">The connection to use to query the database.</param>
        /// <param name="logger">The logger to use to log any errors.</param>
        ...
        internal static async Task<bool> TryEnsureConnected(
