// <copyright file="PostgreSqlAttribute.cs" company="Microsoft Corporation">
...
namespace Microsoft.Azure.WebJobs
{
    ...
    public sealed class PostgreSqlAttribute : Attribute
    {
        ...
        /// <param name="commandText">For an input binding, either a PGSQL query or stored procedure that will be run in the database. For an output binding, the table name to upsert the values to.</param>
        /// <param name="connectionStringSetting">The name of the app setting where the PGSQL connection string is stored.</param>
        public PostgreSqlAttribute(string commandText, string connectionStringSetting)
            : this(commandText, connectionStringSetting, CommandType.Text, null)
        {
        }
        ...
        public PostgreSqlAttribute(string commandText, string connectionStringSetting, string parameters)
            : this(commandText, connectionStringSetting, CommandType.Text, parameters)
        {
        }

        /// <summary>
        /// Gets or sets the name of the app setting where the PGSQL connection string is stored
        ...
        /// <summary>
        /// Gets the command text: For an input binding, either a PGSQL query or stored procedure that will be run in the target database.
        ...
        /// <summary>
        /// Gets the command type: Specifies whether <see cref="CommandText"/> refers to a stored procedure or PGSQL query string.
        ...
        /// <summary>
        /// Gets the parameters: Specifies the parameters that will be used to execute the PGSQL query or stored procedure specified in <see cref="CommandText"/>.
