...
{
    /// <summary>
    /// PostgreSqlInlineData attribute class for adding language parameter data to tests. This allows
    /// tests to be run against all the supported languages list that are specified in the SupportedLanguages
    /// list of this class
    /// </summary>
    public class PostgreSqlInlineDataAttribute : DataAttribute
    {
        ...
        public PostgreSqlInlineDataAttribute(params object[] args)
        {
    ...
    /// <summary>
    /// Attribute class for specifying which languages are not supported for a test
    /// </summary>
    [AttributeUsage(AttributeTargets.Method)]
    public class UnsupportedLanguagesAttribute : Attribute
    {
        /// <summary>
        /// List of languages that are not supported for the test
        /// </summary>
    ...
    /// <summary>
    /// Enum for the supported languages that the tests can be run against
    /// </summary>
