    ...
    public static class TestUtils
    {
        ...
        public static string GetUniqueDBName(string namePrefix)
        {
            ...
            return string.Format(
                ...
                Interlocked.Increment(ref ThreadId)).ToLower();
        }

        /// <summary>
        /// Creates a NpgsqlCommand and calls ExecuteNonQuery against the connection.
        /// </summary>
            ...
            string message = null)
        {
            ...
            try
            {
                ...
                cmd.CommandTimeout = 60; // Increase from default 30s to prevent timeouts
        ...
        /// <summary>
        /// Gets the path to the bin folder of the current assembly
        /// </summary>
